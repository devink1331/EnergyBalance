...
for j = 1:Last_row_in_matrix %construct a matrix (PM_array) full of parameters needed to calculate the FAO PM ET0 equation for each time step and calculate
     ...
     PM_array(j,14) =  (0.408*PM_array(j,1)*(PM_array(j,7)-PM_array(j,8))   +  PM_array(1,9)*(37/(PM_array(j,10)+273))*PM_array(j,11)*(PM_array(j,12)-PM_array(j,13)))   /   (PM_array(j,1)+PM_array(1,9)*(1+0.34*PM_array(j,11)));
